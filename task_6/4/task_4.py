# -*- coding: utf-8 -*-
"""
Created on Sun Dec 24 18:35:56 2023
...
file_name = "G:/Мой диск/ID/[4]vacancies.csv.gz"
...
need_column = dict()
column_names = ["id", "schedule_name", "accept_kids", "address_description",
                "employer_name", "address_lng", "premium", "billing_type_id",
                "experience_name", "allow_messages"]
...
with open("dtypes_4.json", mode="w", encoding = 'utf-8') as file:
...
plt.figure(figsize=(8, 6))
plot_5 = sns.heatmap(dataset[num].corr(),annot=True, cmap='coolwarm')
